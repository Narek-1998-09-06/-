...
class APPMAKER_WC_Third_party_support {
	static function init() {
		...
		if ( function_exists( 'pcmfe_admin_form_field' ) || class_exists( 'pcfme_add_order_meta_class' ) ) {
        ...
        //visualizer	
        if(class_exists('Visualizer_Module')){	
		...
		if ( class_exists( 'APPMAKER_WC_HealthXp' ) ) {
			require 'misc/class-appmaker-wc-hxp.php';
		}

		//WooCommerce advanced messages
		if ( class_exists( 'WooCommerce_Advanced_Messages' ) ) {
