...
class APPMAKER_WC_Gateway_Appmaker extends WC_Payment_Gateway {
	...
	public static function init() {
		if ( isset( $_POST['payment_method'] ) && in_array( $_POST['payment_method'], apply_filters( 'appmaker_wc_checkout_redirect_gateways', array( 'payfort', 'square', 'Pwacheckout', 'midtrans','cashfree','eway_payments','paypal_plus','razorpay'  ) ) ) ) {
